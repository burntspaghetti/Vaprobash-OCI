...
if [[ $2 == "true" ]]; then
    ...
    # Install PHP
    # -qq implies -y --force-yes
    sudo apt-get install -qq php5-cli php5 php5-mysql php5-pgsql php5-sqlite php5-curl php5-gd php5-gmp php5-mcrypt php5-xdebug php5-memcached php5-imagick php5-intl php5-dev libapache2-mod-php5 libaio1
